...
export function useProjects() {
  // Only the native main window merges remote servers; a connection window
  // lists its one remote's projects through the global transport.
  const native = aggregatesServers()
