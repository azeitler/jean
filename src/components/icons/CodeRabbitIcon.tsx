...
type CodeRabbitIconProps = SVGProps<SVGSVGElement> & {
  size?: string | number
}

/** Official CodeRabbit mark from https://www.coderabbit.ai/press-kit/coderabbit-mark-orange.svg */
export const CodeRabbitIcon = forwardRef<SVGSVGElement, CodeRabbitIconProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ref={ref}
...
CodeRabbitIcon.displayName = 'CodeRabbitIcon'
