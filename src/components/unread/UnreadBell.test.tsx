...
const navigateToSessionMock = vi.fn()
vi.mock('@/lib/navigate-to-session', () => ({
  navigateToSession: (...args: unknown[]) => navigateToSessionMock(...args),
}))
...
describe('UnreadBell', () => {
  ...
  it('shows sessions that finish loading after the shortcut opens the popover', async () => {
    ...
    const view = renderWithQueryClient(<UnreadBell />)
